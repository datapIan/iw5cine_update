...
load_defaults()
{
    ...
    level.HIGHLIGHT_COLOR           = "^1";     // "^#" - q3 color code for the hightlights in printed messages.
    ...
    level.ACTOR_SHOW_NAMES          = true;     // [true/false] - Toggles names being displayed when looking at an actor
    level.ACTOR_SHOW_KILLFEED       = true;     // [true/false] - Creates fake killfeed when killing an actor. Only works with IW4x versions that has "emojis" support.

    //  Added features -4g
    level.BOT_WARFARE               = false;
}